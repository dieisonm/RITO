...
- sessões do WAHA ficam em `operations/ai-os/whatsapp/waha/.sessions/`
- credenciais locais do WAHA ficam em `operations/ai-os/whatsapp/waha/.env`
- eventos recebidos ficam em `operations/ai-os/whatsapp/inbox/`
...
- `operations/ai-os/growth/prospecting/territories/novo-hamburgo-rs/batches/2026-04-21-batch-001-whatsapp-manual-queue.csv`
...
- `operations/ai-os/whatsapp/runs/`
...
- bruto: `operations/ai-os/whatsapp/inbox/raw/`
- conversas: `operations/ai-os/whatsapp/inbox/conversations/`
- pendências novas: `operations/ai-os/whatsapp/inbox/pending/pending-replies.jsonl`
