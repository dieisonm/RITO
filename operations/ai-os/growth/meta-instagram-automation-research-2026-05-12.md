...
3. **Pipeline interno RITO**
   ...
   - usar os documentos atuais de `operations/instagram/` e `operations/ai-os/growth/meta-projeto-piloto/` como base.
...
5. so depois montar campanha em pausa usando os ativos existentes em `deliverables/social-assets/meta-projeto-piloto/`.
