...
files: ["site/index.html","site/assets/js/measurement.js","site/contact.php","site/sitemap.xml","site/robots.txt","docs/company/presence/seo-organic-google-baseline.md","docs/company/presence/seo-topic-pages-concept.md"]
...
- O PC servidor deve sincronizar pelo GitHub e usar Google Drive para assets grandes; decisoes duraveis devem ser registradas em `memory/project-memory/entries/`.
