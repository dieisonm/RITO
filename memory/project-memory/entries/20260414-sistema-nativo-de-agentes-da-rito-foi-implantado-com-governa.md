---
id: "20260414-sistema-nativo-de-agentes-da-rito-foi-implantado-com-governa"
project: "RITO"
type: "decision"
status: "active"
title: "Sistema nativo de agentes da RITO foi implantado com governança, fases e operação em pastas"
summary: "A RITO agora tem uma arquitetura documentada de operação nativa no Codex com 10 agentes, governança central, playbooks por fase, templates operacionais e protocolo de memória para continuidade entre sessões."
...
files: ["docs/company/agent-system/implementation-plan.md","docs/company/agent-system/implementation-tracker.md","docs/company/agent-system/agent-directory.md","docs/company/agent-system/operating-model.md","docs/company/agent-system/approval-matrix.md","docs/company/agent-system/memory-protocol.md","docs/company/agent-system/handoff-rules.md","docs/company/agent-system/prompts/README.md","docs/company/agent-system/playbooks/README.md","operations/ai-os/README.md","docs/company/reviews/agent-system-implementation-review.md"]
related_ids: []
issue: ""
pr: ""
commit: ""
