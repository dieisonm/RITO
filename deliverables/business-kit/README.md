...
Os arquivos desta pasta são gerados a partir da base em `docs/company/` e dos scripts de geração. Quando os documentos-fonte ou as regras de precificação forem refinados, execute os scripts novamente para atualizar o kit final.
