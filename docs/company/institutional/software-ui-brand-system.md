...
- Família oficial para software e aplicativos em `logos/systems-and-apps/`

## Regra de logo para produto

- Para software, dashboards, aplicativos e interfaces internas, usar como padrão os SVGs de `logos/systems-and-apps/`.
...
| --- | --- |
| App icon, avatar de produto e navegação compacta | `logos/systems-and-apps/rito-monograma-r-escuro.svg` |
| App icon em fundo escuro | `logos/systems-and-apps/rito-monograma-r-claro.svg` |
| Login, splash, onboarding e header principal | `logos/systems-and-apps/rito-assinatura-horizontal-claro.svg` ou `logos/systems-and-apps/rito-assinatura-horizontal-branco.svg` |
| Rodapé de produto e tela "sobre" | `logos/systems-and-apps/rito-wordmark-claro.svg` ou `logos/systems-and-apps/rito-wordmark-branco.svg` |
| Destaques especiais | `logos/systems-and-apps/rito-monograma-r-areia.svg` ou `logos/systems-and-apps/rito-wordmark-areia.svg` |
...
- a família de logos de `logos/systems-and-apps/` como base visual primária de produto
