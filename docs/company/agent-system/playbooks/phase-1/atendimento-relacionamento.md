...
1. Ler novas entradas em `operations/ai-os/whatsapp/inbox/pending/pending-replies.jsonl`.
2. Abrir o histórico do `chat_id` correspondente em `operations/ai-os/whatsapp/inbox/conversations/`.
