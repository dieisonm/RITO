...
- `docs/company/agent-system/prompts/content-agent.md`
- `docs/company/agent-system/prompts/growth-aquisicao-agent.md`
- `docs/company/agent-system/prompts/branding-agent.md`
- `docs/company/agent-system/prompts/revisor-agent.md`
- `docs/company/agent-system/playbooks/phase-1/conteudo-organico.md`
- `docs/company/agent-system/playbooks/phase-1/growth-aquisicao.md`
- `docs/company/agent-system/playbooks/phase-1/revisor.md`
