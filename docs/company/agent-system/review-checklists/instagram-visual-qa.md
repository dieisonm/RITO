...
- Para a família atual institucional da RITO, preferir os arquivos em `logos/site-and-institutional-high-res/` quando a peça exigir logo grande ou export de alta nitidez.
...
Quando a peça vier de GPT Image 2 ou outra IA de imagem, aplicar também `docs/company/agent-system/gpt-image-2-visual-prompting-guide.md`.
