...
python3 scripts/drive_assets.py register \
  --path deliverables/social-assets/campanha/arte.png \
...
O MCP `project-memory` pode ser instalado depois se necessário, mas o espelho versionado em `RITO/memory/project-memory/entries/` deve ser suficiente para manter Mac e servidor alinhados.
...
### `operations/ai-os/growth/prospecting/`
...
1. O asset nasce localmente em `deliverables/` ou chega por download.
...
- `deliverables/**/*.png`, `jpg`, `webp`, `mp4`, `pdf` e `zip` ficam ignorados pelo Git.
...
```text
operations/ai-os/reviews/YYYY-MM-DD-server-review.md
operations/ai-os/support/YYYY-MM-DD-whatsapp-summary.md
operations/ai-os/growth/YYYY-MM-DD-prospecting-summary.md
docs/company/server-ops/YYYY-MM-DD-server-ops-log.md
```
...
```text
memory/project-memory/entries/*.md
```
...
- registrar a decisão em docs ou em `memory/project-memory/entries/`;
...
```text
rito-smtp.php
operations/ai-os/whatsapp/waha/.env
operations/ai-os/whatsapp/waha/.sessions/
operations/ai-os/whatsapp/.session/
operations/instagram/instagram-access.local.md
operations/website/registrobr-access.local.md
operations/ai-os/whatsapp/inbox/raw/*.jsonl
operations/ai-os/whatsapp/inbox/conversations/*.jsonl
operations/ai-os/whatsapp/inbox/pending/*.jsonl
operations/ai-os/whatsapp/runs/*.jsonl
operations/ai-os/whatsapp/runtime/
.colima/
```
...
operations/ai-os/whatsapp/waha/docker-compose.yml
operations/ai-os/whatsapp/waha/.env.example
...
```text
operations/ai-os/whatsapp/inbox/raw/
operations/ai-os/whatsapp/inbox/conversations/
operations/ai-os/whatsapp/inbox/pending/pending-replies.jsonl
```

Esses dados são locais e ignorados pelo Git. Para sincronizar aprendizado, criar resumo sem dados sensíveis em `operations/ai-os/support/` ou `operations/ai-os/reviews/`.
...
operations/ai-os/growth/prospecting/outbound-automation-architecture.md
```
...
```text
operations/ai-os/growth/prospecting/territories/novo-hamburgo-rs/
```
...
2. Clonar RITO.
3. Validar `memory/project-memory/entries/`.
