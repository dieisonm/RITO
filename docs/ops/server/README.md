...
- `other-computer-onboarding.md`: retomada curta para abrir o projeto com segurança em outro computador.
...
- arquivos grandes ficam no Google Drive em `RITO/assets` e são rastreados por `assets/drive/asset-manifest.json`;
