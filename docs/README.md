...
Esta pasta concentra a documentação estável da RITO.
...
- `roadmap/`: backlog macro da empresa.
...
- documentação estável fica em `docs/`
- operação viva fica em `ops/`
- assets pesados ficam no Google Drive e são registrados em `assets/drive/asset-manifest.json`
- decisões duráveis ficam em `memory/entries/`
