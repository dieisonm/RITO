...
- Ponto de retomada se falhar: verificar `ops/ai-os/README.md`
...
- Ponto de retomada se falhar:
  ...
  - então revisar `docs/reviews/instagram-launch-flow-audit-and-dod.md`
  - então revisar `docs/brand/presence/canva-brand-setup.md`
  - e `docs/agents/agent-system/review-checklists/instagram-visual-qa.md`
